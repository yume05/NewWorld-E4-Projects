...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_MainWindow3_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 35, 23)
    ...
    "MainWindow3\0on_pushButton_clicked\0\0"
...
const QMetaObject MainWindow3::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_MainWindow3.data,
      qt_meta_data_MainWindow3,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MainWindow3.stringdata))
