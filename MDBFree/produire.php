                        ...
                        if(!empty($_FILES['fichier']['name'])) {
                            ...
                            if(!in_array($extension, $extensions)) {
                                ...
                                if(move_uploaded_file($tmpname, $upload_dir.$file)) {
                                    ...
                                    if(isset($_GET['type'])){
                                        $sql = "INSERT INTO produits (libelle, poids, prix, image, idTypeProduits) VALUES ('".$nom."', ".$poids.", ".$prix.", '".$file."', ".$_GET['type'].");";

                                        //$sql2 = "INSERT INTO propose (etat, producteurProduits, producteurUser) VALUES ('ATT', "");";

                                        $reqVerif = "SELECT libelle, poids, prix, image, idTypeProduits FROM produits WHERE libelle = ".$nom." AND image = '".$file."' AND poids = ".$poids." AND prix = ".$prix." AND idTypeProduits = ".$_GET['typeProduits'].";";
                                        ...
                                        //Test connexion à la bdd
                                            if(mysqli_query($connexion, $sql)) {
                                                $reqRecup = "SELECT id FROM produits WHERE libelle = '".$nom."' AND prix = ".$prix." AND poids = ".$poids." AND image = '".$file."';";
                                        ...
                                        $msg = "<center><i><font color=red>Il faut impérativement choisir un rayon et une catégorie</font></i></center>";
                                    }
